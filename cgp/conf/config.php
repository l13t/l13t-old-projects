...
# collectd's datadir
$CONFIG['datadir'] = '/store/collectd/rrd';
...
$CONFIG['cat']['linux'] = array('imago', 'repono');
$CONFIG['cat']['FreeBSD'] = array('universe', 'nest');
$CONFIG['cat']['switches'] = array('dlink_dgs-1210-24', 'dlink_dgs-1210-28', 'dlink_dgs-1210-52');
$CONFIG['cat']['servers'] = array('imago', 'repono', 'universe', 'nest');
